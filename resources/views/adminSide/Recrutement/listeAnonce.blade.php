...
<div class="callout callout-info">
   ...
   <div class="col-sm-6">
      ...
      <div class="form-group">
        <form action="" id="id-filter-form" method="post" action="{{ route('mail.storMail') }}">
          @csrf
         ...
         <div class="col-lg-6 " id="all-anonce">
            <div class="card d-flex flex-row">
               <div class="card-body card-primary p-2" >
                  ...
                  <a href="#" class="card-link text-success"> En traitement </a>
                  <a href="#" class="card-link text-danger"> Non retenus </a>
                  <form method="POST" action="/dashboard/liste-annonce-cv/{{ $an['id'] }}" >
                     @csrf
                     {{-- <span name = "idAnonce" value="{{ $an['id'] }}"></span> --}}
                    <button type="submit" class="btn-primary">Condidat</button>
                  </form>
               </div>
